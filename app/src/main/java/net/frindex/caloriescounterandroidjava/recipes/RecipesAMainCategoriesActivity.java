...
import net.frindex.caloriescounterandroidjava.food_diary_add.FoodDiaryAddRecipeMainCategoriesAdapter;
 ...
 *
 */
public class RecipesAMainCategoriesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_recipes_amain_categories);
    ...
    public void initializeToolbar() {
        ...
        actionBar.setTitle(getResources().getString(R.string.recipes));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.navigationMyRecipes) {
            ...
            // Up button
            Intent i = new Intent(RecipesAMainCategoriesActivity.this, MainActivity.class);
            startActivity(i);
            finish();
        }
    ...
    public void populateARecipeMainCategoriesClicked(int listItemIDClicked) {
        ...
        int currentRecipeMainCategoryId = cursorRecipesMainCategories.getInt(1);
        String currentRecipeMainCategoryTranslationValue = cursorRecipesMainCategories.getString(2);

        // Load sub categories
        Intent i = new Intent(RecipesAMainCategoriesActivity.this, RecipesBShowRecipesInMainCategoryActivity.class);
    ...
    public void populateBRecipesClicked(int listItemIDClicked) {
        ...
        Intent i = new Intent(RecipesAMainCategoriesActivity.this, RecipesCViewRecipeActivity.class);
