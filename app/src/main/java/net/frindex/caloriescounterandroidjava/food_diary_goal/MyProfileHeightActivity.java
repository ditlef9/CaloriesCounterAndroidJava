 ...
 *
 */
public class MyProfileHeightActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_profile_height);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        // Up button
        Intent i = new Intent(MyProfileHeightActivity.this, MyProfileActivity.class);
        startActivity(i);
        finish();
    ...
    private void initializeMeasurementAndMeasurementButton(){
        ...
        if(myUserMeasurement.equals("metric")){
            ...
            editTextHeightCm.setText(myUserHeight);
            ...
            double doubleMyUserHeight = 0;
            try {
                doubleMyUserHeight = Double.parseDouble(myUserHeight);
            }
            catch(NumberFormatException nfe) {
                Toast.makeText(this, "That is not a number (" + nfe.getMessage() + ")", Toast.LENGTH_LONG).show();
            }

            double inches = doubleMyUserHeight/2.54;

            int intFeet = (int)(inches/12);
            inches = inches%12;


            editTextHeightFeet.setText(intFeet + "");
            editTextHeightInches.setText(inches+ "");
        }
        else{
            // Unknown measurement
            DBAdapter db = new DBAdapter(this);
    ...
    private void initializeSaveButtonListeners() {
        ...
        buttonSave.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) { buttonSaveClicked();
            }
        });
    ...
    public void buttonSaveClickedAnswer(){
        // Dynamic Text
        DBAdapter db = new DBAdapter(this);
        db.open();
        String query = "SELECT _id, data FROM json_temp_data ORDER BY _id DESC LIMIT 0,1";
