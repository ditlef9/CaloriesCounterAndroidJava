 ...
 *
 */
public class MyProfileCursorAdapter extends CursorAdapter {


    private LayoutInflater inflater;
    private Context mContext;

    public MyProfileCursorAdapter(Context context, Cursor cursor) {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        // Img (My Profile)
        if(icon.equalsIgnoreCase("ic_outline_straighten_black_24px")){
            imageViewImage.setImageResource(R.drawable.ic_outline_straighten_black_24px);
        }
        else if(icon.equalsIgnoreCase("ic_wc_black_24px")){
            imageViewImage.setImageResource(R.drawable.ic_wc_black_24px);
        }
        else if(icon.equalsIgnoreCase("ic_outline_cake_black_24px")){
            imageViewImage.setImageResource(R.drawable.ic_outline_cake_black_24px);
        }
        else{
