 ...
 *
 */
public class MyProfileDobActivity extends AppCompatActivity {
    /* Api variables */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_profile_dob);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        // Up button
        Intent i = new Intent(MyProfileDobActivity.this, MyProfileActivity.class);
        startActivity(i);
        finish();
    ...
    private void buttonSaveListeners() {
