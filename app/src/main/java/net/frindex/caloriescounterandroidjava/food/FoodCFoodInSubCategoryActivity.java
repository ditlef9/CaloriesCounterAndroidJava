...
/**
 *
 * File: FoodCFoodInSubCategoryActivity.java
 * Version 1.0.0
 * Date 18.02.2022
...
public class FoodCFoodInSubCategoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_food_cfood_in_sub_category);
        ...
        currentFoodSubCategoryId = b.getInt("currentFoodSubCategoryId");
        currentFoodSubCategoryTranslationValue = b.getString("currentFoodSubCategoryTranslationValue");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.navigationMyFood) {
            ...
            // Up button
            Intent i = new Intent(FoodCFoodInSubCategoryActivity.this, FoodBSubCategoriesActivity.class);
    ...
    public void textViewMainPreviousClicked(){
        Intent i = new Intent(FoodCFoodInSubCategoryActivity.this, FoodAMainCategoriesActivity.class);
        startActivity(i);
        finish();
    ...
    public void populateCFoodInCategory(){
    ...
    public void populateCFoodClicked(int listItemIDClicked) {
        ...
        // Load Food
        Intent i = new Intent(FoodCFoodInSubCategoryActivity.this, FoodDViewFoodActivity.class);
