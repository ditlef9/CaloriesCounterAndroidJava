...
/**
 *
 * File: FoodDViewFoodActivity.java
 * Version 1.0.0
 * Date 18.02.2022
...
public class FoodDViewFoodActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_food_dview_food);


        Bundle b = getIntent().getExtras();
        currentFoodId = b.getInt("currentFoodId");
    ...
    public void initializeToolbar() {
        ...
        actionBar.setTitle(getResources().getString(R.string.food) + " > " + currentFoodName);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        // Find main category ID and sub category ID

        // Up button
        Intent i = new Intent(FoodDViewFoodActivity.this, FoodCFoodInSubCategoryActivity.class);
        ...
        i.putExtra("currentFoodSubCategoryId", currentFoodSubCategoryId);
        i.putExtra("currentFoodSubCategoryTranslationValue", currentFoodSubCategoryTranslationValue);
        startActivity(i);
        finish();
    ...
    public void loadFood(){
        ...
        String query = "SELECT _id, food_id, food_user_id, " +
                ...
                "food_dislikes FROM food_index WHERE food_id='" + currentFoodId + "'";
        Cursor cursorFood = db.rawQuery(query);
        ...
        // Sub category
        query = "SELECT food_categories._id, food_categories.category_id, food_categories.category_name, food_categories.category_parent_id, " +
                ...
                "AND food_categories.category_id='" + currentFoodCategoryId + "'";
        Cursor cursorFoodSubCategories = db.rawQuery(query);
        ...
        query = "SELECT food_categories._id, food_categories.category_id, food_categories.category_name, food_categories.category_parent_id, " +
                ...
                "JOIN food_categories_translations ON food_categories.category_id=food_categories_translations.category_id " +
                " WHERE food_categories.category_user_id='0' " +
                "AND food_categories.category_id='" + currentFoodSubCategoryId + "'";
        Cursor cursorFoodMainCategories = db.rawQuery(query);
    ...
    public void textViewGramOrPcsClicked(String gramOrPcs){
        ...
        // Go to main
        Intent i = new Intent(FoodDViewFoodActivity.this, MainActivity.class);
