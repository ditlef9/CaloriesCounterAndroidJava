...
import net.frindex.caloriescounterandroidjava.food_diary_add.FoodDiaryAddFoodSubCategoriesAdapter;
/**
 *
 ...
 *
 */
public class FoodBSubCategoriesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_food_bsub_categories);

        Bundle b = getIntent().getExtras();
        currentFoodMainCategoryId = b.getInt("currentFoodMainCategoryId");
        currentFoodMainCategoryTranslationValue = b.getString("currentFoodMainCategoryTranslationValue");
    ...
    public void initializeToolbar() {
        ...
        actionBar.setTitle(getResources().getString(R.string.food) + " > " + currentFoodMainCategoryTranslationValue);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.navigationMyFood) {
            ...
            // Up button
            Intent i = new Intent(FoodBSubCategoriesActivity.this, FoodAMainCategoriesActivity.class);
            startActivity(i);
            finish();
        }
    ...
    public void populateBFoodSubCategoriesClicked(int listItemIDClicked) {
        ...
        int currentFoodSubCategoryId = cursorFoodSubCategories.getInt(1);
        String currentFoodSubCategoryTranslationValue = cursorFoodSubCategories.getString(4);

        // Load sub categories
        Intent i = new Intent(FoodBSubCategoriesActivity.this, FoodCFoodInSubCategoryActivity.class);
    ...
    public void populateCFoodClicked(int listItemIDClicked) {
        ...
        // Load Food
        Intent i = new Intent(FoodBSubCategoriesActivity.this, FoodDViewFoodActivity.class);
