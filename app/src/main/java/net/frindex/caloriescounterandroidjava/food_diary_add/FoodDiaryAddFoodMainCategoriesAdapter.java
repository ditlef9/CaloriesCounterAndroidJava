...
/**
 *
 * File: FoodDiaryAddFoodMainCategoriesAdapter.java
 * Version 1.0.0
 * Date 18.02.2022
...
public class FoodDiaryAddFoodMainCategoriesAdapter extends CursorAdapter {


    private LayoutInflater inflater;
    private Context mContext;

    public FoodDiaryAddFoodMainCategoriesAdapter(Context context, Cursor cursor) {
